...
public void actionPerformed(ActionEvent ae) {
	...
	public void paint(Graphics g) {
		g.drawString("sum is : "+String.valueOf(sum),10,120);
		g.drawString("percentage  is : "+String.valueOf(percentage),10,120);
              		if(percent<=50.0)
